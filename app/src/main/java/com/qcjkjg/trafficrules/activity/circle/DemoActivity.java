...
public class DemoActivity extends BaseActivity implements View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(DemoActivity.this, 4, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(DemoActivity.this, onAddPicClickListener);
            ...
            public void onItemClick(int position, View v) {
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            // 预览图片 可自定长按保存路径
                            //PictureSelector.create(DemoActivity.this).externalPicturePreview(position, "/custom_file", selectList);
                            PictureSelector.create(DemoActivity.this).externalPicturePreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(DemoActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(DemoActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(DemoActivity.this);
                } else {
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            PictureSelector.create(DemoActivity.this)
