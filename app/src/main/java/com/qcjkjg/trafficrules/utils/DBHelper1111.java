 ...
 */
public class DBHelper1111 extends SQLiteOpenHelper {
    ...
    public DBHelper1111(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
        this.mContext = context;
    }

    public DBHelper1111(Context context, String name, SQLiteDatabase.CursorFactory factory,
                        int version) {
