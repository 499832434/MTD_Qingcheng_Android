...
/**
 * Created by zongshuo on 2017/9/8.
 */
public class AddSub {
    private String jqyy;
    private String vip;
    ...
    public void setDtjq(String dtjq) {
        this.dtjq = dtjq;
    }

    public String getSubChapte() {
        return subChapte;
    }

    public void setSubChapte(String subChapte) {
        this.subChapte = subChapte;
    }
